...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Guzel Travels — Travel With Confidence" },
      { property: "og:description", content: "Cheap flights, visa consultancy, Umrah packages and luxury car rentals from Lahore." },
